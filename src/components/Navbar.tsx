...
const Navbar = () => {
    ...
    const MENU_LINKS = [
        { name: t('nav.home'), url: '/' },
        { name: t('nav.about'), url: '/#about-me' },
        { name: t('nav.education'), url: '/#education-awards' },
        { name: t('nav.projects'), url: '/#selected-projects' },
    ];
    ...
    return (
        <>
            ...
            >
                ...
                <div className="w-full max-w-[300px] mx-8 sm:mx-auto space-y-6">
                    <div>
