...
type Props = LinkProps | ButtonOnlyProps;
...
const Button = (props: Props) => {
    ...
    if (as === 'link') {
        ...
        if (target === '_blank') {
            return (
                ...
                >
                    ...
                    <span className="z-[1] group-hover:text-background transition-colors duration-500">
        ...
        const { as: _, loading: __, icon: ___, variant: ____, ...buttonProps } = props as ButtonOnlyProps;
