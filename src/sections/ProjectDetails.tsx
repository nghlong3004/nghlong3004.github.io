            ...
            <div className="container" ref={containerRef}>
                ...
                >
                    <div className="relative w-full">
                        ...
                        <div className="max-w-[635px] space-y-7 pb-20 mx-auto">
                            ...
                            <div className="fade-in-later">
                                <p className="text-muted-foreground font-anton mb-3">
                                    {t('project_detail.tech') || 'Tech & Technique'}
                                </p>
                            ...
                            <div className="fade-in-later">
                                <p className="text-muted-foreground font-anton mb-3">
                                    {t('project_detail.description') || 'Description'}
                                </p>

                                <div className="text-lg prose-xl markdown-text">
                                    {parse(t(project.description))}
                                </div>
                            </div>
                            {project.role && (
                                <div className="fade-in-later">
                                    <p className="text-muted-foreground font-anton mb-3">
                                        {t('project_detail.role') || 'My Role'}
                                    </p>

                                    <div className="text-lg">
                                        {parse(t(project.role))}
                                    </div>
                                </div>
                            )}
                        </div>
                ...
                >
                    {project.images.map((image) => (
                        <div
                            key={image}
                            className="group relative w-full aspect-video overflow-hidden rounded-xl border border-border/30 bg-background-light"
                            style={{
